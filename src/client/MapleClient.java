...
public class MapleClient {
    ...
    public int login(String login, String pwd, boolean ipMacBanned) {
        ...
        Connection con = DatabaseConnection.getConnection();
        try {
            PreparedStatement ps = con.prepareStatement("SELECT id, password, salt, gender, banned, donations, pin, pic, characterslots, greason, tempban FROM accounts WHERE name = ?");
            ...
            if (rs.next()) {
                ...
                donations = rs.getDouble("donations");
