...
public final class AllianceOperationHandler extends AbstractMaplePacketHandler {
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        if (alliance == null) {
            c.getPlayer().message("You are not in an alliance.");
            ...
            switch (slea.readByte()) {
                ...
                case 0x03: // send alliance invite
                    ...
                    if (channel == -1) {
                        c.getPlayer().message("The player is not online.");
                    } else {
                        ...
                        if (victim.getGuildId() == 0) {
                            c.getPlayer().message("The person you are trying to invite does not have a guild.");
                        } else if (victim.getGuildRank() != 1) {
                            c.getPlayer().message("The player is not the leader of his/her guild.");
                        } else {
...
//                    slea.readMapleAsciiString();//guild name
                ...
                case 0x0A:
                    ...
                    break;
                default:
                    c.getPlayer().message("Feature not available");
            }
            alliance.saveToDB();
    }
