...
public final class CloseRangeDamageHandler extends AbstractDealDamageHandler {
    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        //attack = skinning.applyDemi(player, attack);
        ...
        if (isFinisher(attack.skill)) {
            ...
            } else if (player.getSkillLevel(player.isCygnus() ? SkillFactory.getSkill(15100004) : SkillFactory.getSkill(5110001)) > 0 && (player.getJob().isA(MapleJob.Marauder) || player.getJob().isA(MapleJob.Thunder_Breaker_2))) {
                for (int i = 0; i < attack.initialNum; i++) { // attack.numAttacked
