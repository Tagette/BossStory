...
public class MaplePacketCreator {
     ...
     */
    public static MaplePacket spawnPlayerMapobject(MapleCharacter chr, boolean showId) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendOpcode.SPAWN_PLAYER.getValue());
        mplew.writeInt(chr.getId());
        mplew.write(chr.getLevel()); //v83
        mplew.writeMapleAsciiString(chr.getName() + (showId ? " (" + chr.getId() + ")" : ""));
        if (chr.getGuildId() < 1) {
    ...
    public static MaplePacket getPlayerNPC(PlayerNPC npc) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    /**
     * Makes multiple NPC's in the game scriptable.
     * @param npc - A list of NPC's with descriptions
     * @return 
     */
